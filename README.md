...
- Handled asset management and inventory tracking for homeowners insurance
- Created manufacturing invoices and coordinated with teams on demolition work
...
### [osTicket Data Center Ticketing System](https://github.com/besmeralda1/osticket-lab)
Built a fully functional data center ticketing system using osTicket on Azure VMs to demonstrate IT support workflows and ticket management.

**Tech Stack:** Ubuntu Linux, Apache, MySQL, osTicket  
**Key Features:**
...
### [Job Discovery Tool](https://github.com/besmeralda1/job-search)
A Python CLI that queries the JSearch API to find IT/sysadmin job postings across Texas, scores results against a resume profile, and prints a ranked list to the terminal.

**Tech Stack:** Python 3 (stdlib only), RapidAPI / JSearch  
**Key Features:**
- Scores jobs on title match, skill match, salary fit, and freshness
- 25+ targeted queries across DFW, Austin, Houston, and remote Texas
- Deduplicates across job boards by job ID and employer+title pair
- Zero dependencies — runs anywhere Python 3 is installed

### [Claude Code Usage Dashboard](https://github.com/besmeralda1/usage-dashboard)
A local web dashboard that tracks Claude Code token usage against the Pro window limit in real time.

**Tech Stack:** Python 3, SQLite, HTML/CSS/JS  
**Key Features:**
- Live token gauge with progress bar (green/yellow/red)
- Countdown timer to window reset
- 7-day usage bar chart
- Auto-refreshes every 60 seconds — no pip or npm required
...
- Gaming (I'm a League of Legends player, also play Valorant and Geometry Dash)
- Playing basketball,football,badminton and working on fitness goals
- Fishing and exploring the outdoors

---

💡 **Open to opportunities** in data center operations, cloud infrastructure, and IT support roles in the DFW area. Let's connect if you're hiring or want to collaborate on projects!
